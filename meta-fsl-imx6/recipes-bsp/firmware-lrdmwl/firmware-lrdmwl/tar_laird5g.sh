...
tar cvf firmware-lrdmwl5g.tar1  lrdmwl_sdio.ko lrdmwl.ko cfg80211.ko mac80211.ko compat.ko bluetooth.ko hci_uart.ko lrdmwl_sdio.md5 lrdmwl.md5 cfg80211.md5 mac80211.md5 compat.md5 bluetooth.md5 hci_uart.md5
